...
export const SignUp = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setAlertMessage(
        `A verification link has been sent to ${email}. Please check your mailbox and follow the instructions to complete registration.`,
      );
      setAlertType(
      ...
      setAlertType(
        "bg-orange-100 border-t-4 border-orange-500 text-orange-700 p-4",
      );
      setShowAlert(true);
    } finally {
                ...
                <div className="lg:col-12">
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      placeholder="name"
                      id="grid-first-name"
                      className={`bg-gray-200 px-4 py-2 rounded-md w-full ${!nameValid && "outline-red"}`}
                      autoComplete="name"
                      required
                      value={name}
                ...
                <div className="lg:col-12">
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className={`bg-gray-200 px-4 py-2 rounded-md w-full ${!emailValid && "outline-red"}`}
                      autoComplete="email"
                      required
                      value={email}
                ...
                <div className="lg:col-12">
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="password"
                      placeholder="••••••"
                      className={`bg-gray-200 px-4 py-2 rounded-md w-full ${!passwordValid && "outline-red"}`}
              ...
              <div class="flex flex-col items-start justify-center sm:w-1/2 w-full mx-auto">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm mb-4">
                    <label
                      for="terms"
                      class="font-light text-primary-600 dark:text-gray-300"
                    >
                      I accept the{" "}
                      <a
                        class="font-medium text-bold text-DarkBlue hover:underline dark:text-primary-500"
                        href="#"
                      >
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm mb-4">
                    <label
                      ...
                      class="font-light text-primary-600 dark:text-gray-300"
                    >
                      I agree to receive news, promotions and emails from Torino
                      Print.
                    </label>
                  </div>
                </div>
                ...
                <button
                  ...
                  type="submit"
                  disabled={isRegistering}
                  className="bg-SuperPink text-white px-4 py-2 rounded-md w-full"
                >
                  Create an account
                </button>
