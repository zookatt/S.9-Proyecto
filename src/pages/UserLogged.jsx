...
export const UserLogged = () => {
  ...
  return (
    <div>
      <h1 className="sm:text-5xl text-2xl text-start font-bold mb-3 flex">
        Welcome, {userLoggedIn.email}
      </h1>
      ...
      <div class="bg-white  shadow overflow-hidden sm:rounded-lg mt-5">
        <div class="px-4 py-5 sm:px-6">
          ...
          <p class="mt-1  text-sm text-gray-500">Designes made by me</p>
          <div className="flex flex-wrap justify-center">
            {userCanvas
              ...
              .map((userCanva, index) => (
                <div
                  key={index}
                  className="flex sm:w-1/3 w-full py-4 justify-center"
                >
