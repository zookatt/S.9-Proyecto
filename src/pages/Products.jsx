            ...
            <section id="Projects"
                ...
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        ...
                        <div className="px-4 py-3 w-72">
                            ...
                            <p className="text-lg font-bold text-black truncate block capitalize">Barcelona</p>
                            <div className="flex items-center">
                ...
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    <a href="#">
                        ...
                        <div className="px-4 py-3 w-72">
                            <span className="text-gray-400 mr-3 uppercase text-xs">Tote Bag</span>
                            <p className="text-lg font-bold text-black truncate block capitalize">I'm Not Plastic</p>
                            <div className="flex items-center">
