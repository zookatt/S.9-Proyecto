      ...
      >
        ...
        <div className="sm:order-3 flex items-center gap-x-2">
          ...
          >
            ...
            >
              <line x1="3" x2="21" y1="6" y2="6" stroke="#E8D20E" />
              <line x1="3" x2="21" y1="12" y2="12" stroke="#D71987" />
              <line x1="3" x2="21" y1="18" y2="18" stroke="#0B4E9C" />
            </svg>
          </button>
          {userLoggedIn ? (
            <>
            ...
            <>
              ...
              <Link to="/signup">
                <button
                  type="button"
                  className="py-2 px-3 inline-flex items-center hover:text-white gap-x-2 text-sm font-bold rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-SuperPink disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                >
                  Sign Up
                </button>
              </Link>
        ...
        <div
          ...
          className={
            isCollapsed
              ? "hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:grow-0 sm:basis-auto sm:block sm:order-2"
        ...
        >
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
            ...
            <Link
              to="/about"
              className="font-bold text-gray-800 hover:text-DarkBlue dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="#"
            >
              ABOUT
            </Link>
