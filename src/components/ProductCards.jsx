    ...
    return (
        <section className='mb-12'>
            ...
            <div className="flex flex-col sm:flex-row justify-center">
                <div className="card sm:w-1/4  me-4 mb-5 bg-SuperPink shadow-xl">
                ...
                <div className="card sm:w-1/4  me-4 mb-5 bg-SkyBlue shadow-xl">
                ...
                <div className="card sm:w-1/4 me-4 mb-5 bg-YellowSun shadow-xl">
